...
function Editor({activeNote, onUpdateNote, valueTitle, setValueTitle, valueBody, setValueBody}) {
  ...
  return (
    <div className="main-wrapper">
      ...
      <div className="main-note-edit">
        ...
        <button className="saveBtn" onClick={()=> onEditField('title', valueTitle, 'body', valueBody)}>
          Сохранить задачу
        </button>
