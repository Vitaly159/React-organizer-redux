...
function DatesSelectors({ month, year, setYear, setMonth }) {
  ...
  return (
    <div className="wrapper-selectors">
      <div className="selectors">
        <select
          value={month}
          onChange={(e) => upDateCalendar(Number(e.target.value), year)}
        >
        ...
        <select
          value={year}
          onChange={(e) => upDateCalendar(month, Number(e.target.value))}
        >
      ...
      <div>
        <button className="arrows" onClick={() => handlePrevMonthBtn()}>
          {"<"}
        </button>
        <button className="arrows" onClick={() => handleNextMonthBtn()}>
          {">"}
        </button>
      </div>
    </div>
